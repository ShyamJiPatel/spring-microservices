...
public class EmployeeRestController {
	...
	@RequestMapping(value = "/employeeByProjectName/{projectName}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<String>> getEmployeeByProjectName(@PathVariable("projectName") String projectName) {

		List<String> employee = employeeService.findAllByProjectName(projectName);
